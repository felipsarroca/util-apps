document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupConfigForm(type) {
        ...
        if (type.includes('poll')) {
            rowFields += '<div class="form-group"><label for="votes-per-student">Màxim de vots per participant</label><input type="number" id="votes-per-student" name="votesPerStudent" value="1" min="1"></div>';
        }
        if (rowFields) {
